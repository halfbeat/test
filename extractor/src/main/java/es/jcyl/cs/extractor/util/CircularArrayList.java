...
public class CircularArrayList extends AbstractList implements List, Serializable {
	 ...
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -91681291669313786L;
	...
	public Object[] toArray(Object a[]) {
		...
		if (head < tail) {
			...
			System
					.arraycopy(elementData, head, a, 0, elementData.length
							- head);
			System
					.arraycopy(elementData, 0, a, elementData.length - head,
							tail);
		}
		if (a.length > size)
			a[size] = null;
